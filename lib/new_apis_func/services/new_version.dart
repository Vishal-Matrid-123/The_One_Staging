...
class NewVersion {
/*   An optional value that can override the default packageName
    when  attempting to reach the Apple App Store. This is useful if your app has
...
/*   This function attempts to clean local version strings so they match the MAJOR.MINOR.PATCH
  ...
  Future<VersionStatus?> _getiOSStoreVersion(PackageInfo packageInfo) async {
    ...
    return VersionStatus._(
      ...
      releaseNotes: stripHtmlIfNeeded(jsonObj['results'][0]['releaseNotes']),
    );
  }
  ...
  */
  void showUpdateDialog({
    ...
    final dialogTextWidget = Text(
      dialogText ??
          '\nCurrent Version: ${versionStatus.localVersion}\nAvailable Version: ${versionStatus.storeVersion}\n\n${versionStatus.releaseNotes!}\n',
