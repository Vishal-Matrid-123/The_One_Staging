...
class HeartIcon {
  ...
  static const IconData password = IconData(0xe800,
      fontFamily: _kFontFamChangePassword, fontPackage: _kFontPkg);
  ...
  static const IconData searchFilter = IconData(
    0xf1de,
    fontFamily: _kFontFamSearch,
  );

  static const _socialMediaFam = 'SocialMedia';

  static const IconData socialMedia = IconData(
    0xf1de,
    fontFamily: _socialMediaFam,
  );
  static const _kFontFamInsta = 'MyFlutterApp';

  static const _kFontFamInstagram = 'InstaGramIcon';

  static const IconData instagram1 = IconData(
    0xf16d,
    fontFamily: _kFontFamInstagram,
  );

  static const _kFontFamReturnRequest = 'ReturnRequest';
  static const IconData returnRequest = IconData(
    0xe801,
    fontFamily: _kFontFamReturnRequest,
  );
  static const _kFontFamShare = 'Share';

  static const IconData share = IconData(
    0xe801,
    fontFamily: _kFontFamShare,
  );
  static const _kFontFamDelete = 'Delete';

  static const IconData delete_sweep = IconData(
    0xe800,
    fontFamily: _kFontFamDelete,
  );

  static const _kFontFamHeart = 'HeartIcom';

  static const IconData heart2 =
      IconData(0xe800, fontFamily: _kFontFamHeart, fontPackage: _kFontPkg);
