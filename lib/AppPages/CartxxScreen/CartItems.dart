                                      ...
                                      onTap: () async {
                                        ...
                                        if (widget.quantity < 1) {
                                          ...
                                          ApiCalls.updateCart(
                                            ...
                                            ApiCalls.readCounter(
                                                context: context);
                                             // if(value.toString().contains('null') || value.toString().contains(kerrorString)) {
                                             //   setState(() {
                                             //      CartWrapper.warningVisible = false;
                                             //      CartWrapper.warning = '';
                                             //   });
                                             // } else {
                                             //   setState(() {
                                             //     CartWrapper.warningVisible = true;
                                             //     CartWrapper.warning = value.toString();
                                             //   });
                                             // }
                                            widget.updateUi();
                                            widget.reload();
