  ...
  Future<void> showAndUpdateUi() async {
    await _provider.showCart().whenComplete(() {
      ...
      setState(() {
        ...
        taxRate = _provider.cartModel.orderTotalsModel.taxRates.isEmpty?'':_provider.cartModel.orderTotalsModel.taxRates[0].rate;
taxVisible = _provider.cartModel.orderTotalsModel.displayTaxRates??false;
            ...
            child: SmartRefresher(
              ...
              child: ListView(
                children: [
                  ...
                  // Visibility(
                  //   visible: CartWrapper.warningVisible,
                  //   child: Padding(
                  //     padding: const EdgeInsets.fromLTRB(8.0, 15, 8, 15),
                  //     child: Row(
                  //       mainAxisSize: MainAxisSize.max,
